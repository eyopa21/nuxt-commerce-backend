...
const sendEmail = async(email, code, message) => {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="font-size: 14px; color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">E Y O B A    &nbsp;&nbsp;  C O M M E R C E </span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">${message}: <strong>${code}</strong></span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;"><span style="font-size: 18px; line-height: 28.8px;">Eyob Nigussie</span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="font-size: 14px; color: #003399; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 16px; line-height: 25.6px; color: #000000;">+251918784596</span></p>
                                                                <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 16px; line-height: 25.6px; color: #000000;">jobtennis21@gmail.com</span></p>
                                                            </div>
...
mutation($user_id: uuid!, $phone_number: String!, $subject: String!, $message: String!, $full_name: String!, $email: String!) {
  insert_messages_one(object: {user_id: $user_id, phone_number: $phone_number, subject: $subject, message: $message, full_name: $full_name, email: $email}) {
    id
    email
  }
}
`;
    const { user_id, phone_number, subject, message, full_name, email } = req.body.input;
    try {

        const data = await client.request(HASURA_OPERATION, { user_id, phone_number, subject, message, full_name, email })
        console.log(data)
        ...
        if (data.insert_messages_one) {
            ...
            sendEmail(data.insert_messages_one.email, message, subject).then((email) => {
            ...
            return res.status(400).json({ message: 'Sending failed' });
        }
